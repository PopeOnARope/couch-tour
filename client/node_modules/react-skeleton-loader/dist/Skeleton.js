...
var Skeleton = function Skeleton(props) {
  ...
  var wm = props.width.toString().replace(/\d+/g, '');
  var hm = props.height.toString().replace(/\d+/g, '');
  ...
  for (var i = 0; i < props.count; i++) {
    var _width = '' + (w - Math.random() * w * props.widthRandomness) + wm;
    var _height = '' + (h - Math.random() * h * props.heightRandomness) + hm;
    ...
    if (i !== props.count - 1) {
      elements.push(_react2.default.createElement('br', null));
    }
  }
